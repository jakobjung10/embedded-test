...
- Update syn to v3
- Bump MSRV to 1.88 (via darling 0.24)
...
[Unreleased]: https://github.com/probe-rs/embedded-test/compare/v0.7.2...master

[0.7.2]: https://github.com/probe-rs/embedded-test/compare/v0.7.1...v0.7.2
